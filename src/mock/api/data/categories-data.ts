export const SEVERAL_BROWSE_CATEGORIES = {
  categories: {
    href: 'https://api.spotify.com/v1/browse/categories?country=KR&locale=ko_kr&offset=0&limit=20',
    items: [
      {
      ...
      {
        href: 'https://api.spotify.com/v1/browse/categories/0JQ5DAqbMKFQtzIMjOW2bE',
        icons: [
          {
            height: null,
            url: 'https://t.scdn.co/images/17ea76835e554ef19fb74db86c4eb287',
            width: null,
          },
        ],
        id: '0JQ5DAqbMKFQtzIMjOW2bE',
        name: '가요 ',
      },
      {
    ...
    limit: 20,
    next: 'https://api.spotify.com/v1/browse/categories?country=KR&locale=ko_kr&offset=20&limit=20',
    offset: 0,
    previous: null,
    total: 52,
  },
